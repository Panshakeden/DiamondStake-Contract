...
import "../libraries/LibERC20AppStorage.sol";
import "../interfaces/IERC20.sol";

contract ERC20LayoutFacet is IERC20 {
    LibERC20AppStorage.ERC20Layout token;
    ...
    function transfer(address to, uint256 amount) public virtual override returns (bool) {
        address owner = token._TokenOwner;
    ...
    function transferFrom(
        ...
        address spender = token._TokenOwner;
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        uint256 accountBalance = token.balances[account];
